...
$url        = 'https://www.argusmonitor.com/downloads/ArgusMonitor_Setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'argus-monitor*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided.
  # You can also use checksum.exe (choco install checksum) and use it
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'D54AA1A256D95165D395B45CEB9E0118156B0E4371D776016CB518AD111F96B6'
